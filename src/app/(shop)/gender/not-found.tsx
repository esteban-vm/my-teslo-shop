  ...
  return (
    <PageContainer>
      <div className='text-center font-montserrat text-error'>
        ...
        <Button as={Link} color='warning' href='/' link>
          Regresar al inicio
        </Button>
      </div>
...
const PageContainer = tw.div`-translate-1/2 absolute top-1/2 left-1/2 flex w-full flex-col-reverse items-center justify-evenly md:flex-row md:justify-center md:gap-4`
